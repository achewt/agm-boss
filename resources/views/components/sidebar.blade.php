<div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="active"><a class="nav-link" href="{{ route('home') }}"><i class="far fa-square"></i> <span>Building</span></a></li>
              ...
              <li><a class="nav-link" href="{{ route('view-cities') }}"><i class="fas fa-pencil-ruler"></i> <span>City</span></a></li>
              <li><a class="nav-link" href="{{ route('view-departments') }}"><i class="fas fa-pencil-ruler"></i> <span>Department</span></a></li>
              <li><a class="nav-link" href="{{ route('view-designations') }}"><i class="fas fa-pencil-ruler"></i> <span>Designation</span></a></li>
